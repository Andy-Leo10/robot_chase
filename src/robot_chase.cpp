...
{
public:
  RobotChase(const std::string &origin_frame, const std::string &destiny_frame, const std::string &cmd_vel_topic = "rick/cmd_vel")
...
int main(int argc, char **argv)
{
  ...
  rclcpp::spin(
      std::make_shared<RobotChase>("rick/base_link", "morty/base_link", "rick/cmd_vel"));
  rclcpp::shutdown();
  return 0;
}